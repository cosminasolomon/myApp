// let quizzGeography = document.getElementById("questionsGeography");
...
// };
// questionGeography();
// quizzGeography.addEventListener("load", questionGeography);
...
function useApiData(newArray, data) {
  document.getElementById("questionsGeography").innerHTML =
  ...
  answer1.addEventListener("click", (e) => {
    if (newArray[0] === data.results[0].correct_answer) {
      ...
      setTimeout(function () {
        window.location.assign("./questionsGeography.ejs");
      }, 700);
    } else {
